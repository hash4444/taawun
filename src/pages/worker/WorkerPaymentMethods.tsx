      ...
      <div className="px-4 py-4">
        <div className="bg-primary-light rounded-xl p-4">
          <p className="text-sm text-primary">
            {isRTL 
              ? 'سيتم تحويل أرباحك إلى طريقة الدفع الافتراضية'
              : 'Your earnings will be transferred to your default payment method'}
          </p>
        </div>
      </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {account.is_default && (
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-primary text-primary-foreground text-xs">
                          <Check size={12} />
                          {t('defaultAccount')}
                        </span>
                      )}
